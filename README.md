...
Download the docker-compose.yml, the .env and the setup.sh files:
    ...
    curl -o .env https://raw.githubusercontent.com/gmasse/docker-mailserver/master/.env.dist
    
    curl -o env-mailserver https://raw.githubusercontent.com/gmase/docker-mailserver/master/env-mailserver.dist
